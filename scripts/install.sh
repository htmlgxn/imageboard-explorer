...
APP_NAME="imgboard-explorer"
DEFAULT_DEV_DIR="$HOME/projects/imgboard-explorer"
...
print_header() {
    ...
    if [ "$DEV_MODE" = true ]; then
        echo "║     comfy-imageboard-explorer Dev Installer              ║"
    else
        echo "║        comfy-imageboard-explorer Installer               ║"
    fi
    echo "╚══════════════════════════════════════════════════════════╝"
    echo -e "${RESET}"
}
...
#!/bin/bash
cd "$DEV_DIR" && uv run imgboard-explorer "\$@"
EOF
